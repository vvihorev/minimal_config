...
nnoremap <Leader>Rj <Cmd>w<CR><Cmd>!javac % && java %:r<CR>
"nnoremap <Leader>Rc <Cmd>w<CR><Cmd>!g++ % -o %:r && ./%:r<CR>
nnoremap <Leader>Rc <Cmd>w<CR><Cmd>!gcc -O2 % -o %:r && ./%:r<CR>
nnoremap <Leader>Rs <Cmd>w<CR><Cmd>!gcc -O2 -S % && cat %:r.s<CR>
nnoremap <Leader>Rp <Cmd>w<CR><Cmd>!python3 %<CR>
"nnoremap <Leader>Rs <Cmd>w<CR><Cmd>!sent %<CR>

nnoremap <Leader>L <Cmd>!grep -E "class\|def" %<CR>

nnoremap <Leader>zs <Cmd>set foldmethod=syntax<CR>
nnoremap <Leader>fs <Cmd>:w<CR>
nnoremap <Leader>аы <Cmd>:w<CR>
nnoremap <Leader>fc <Cmd>:q<CR>
nnoremap <Leader>ff <Cmd>FZF<CR>
nnoremap <Leader>mx <Cmd>VimwikiToggleListItem<CR>
nnoremap <Leader>ьч <Cmd>VimwikiToggleListItem<CR>
nnoremap <Leader>ьр <Cmd>s/^/# /<CR>
nnoremap <Leader>mh <Cmd>s/^/# /<CR>

nnoremap <Leader>Fm :set filetype=markdown<CR>

let g:repl_filetype_commands = {'python': 'python',}
nnoremap ,s <Cmd>ReplSend<CR>
nnoremap ,c <Cmd>ReplClear<CR>
nnoremap ,t <Cmd>ReplToggle<CR>
xnoremap ,s :'<,'>ReplSend<CR>
nnoremap ,r <Cmd>: set rnu! rnu?<CR>
