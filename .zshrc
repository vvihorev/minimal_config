...
path=('/Users/vvihorev/.local/bin' $path)
path=('/Users/vvihorev/.local/bin' $path)
path=('/user/local/bin' $path)
path=('/Users/vvihorev/go/bin' $path)
path=('/Users/vvihorev/.config/emacs/bin' $path)
...
#alias bm="nvim ~/.config/shell/bm-dirs"
...
alias work="timer 60m && terminal-notifier -message 'Pomodoro'\
        ...
        -sound Crystal && date '+%Y-%m-%d %H:%M' >> /Users/vvihorev/pomodoro.log"
...
[ -f "/Users/vvihorev/.ghcup/env" ] && source "/Users/vvihorev/.ghcup/env" # ghcup-env
